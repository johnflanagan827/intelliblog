        ...
        <main className="w-full h-screen flex flex-col items-center justify-center px-4">
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                ...
                <div className="space-y-5 bg-white shadow p-4 py-6 sm:p-6 sm:rounded-lg">
                    <form onSubmit={(e) => loginUser(e)} className="space-y-7">
                        <div>
                            ...
                            <input
                                ...
                                maxLength={256}
                                className="border border-gray-300 w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none focus:border-indigo-600 shadow-sm rounded-lg"
                            />
                        </div>
                        <div>
                            <div className="mb-8">
