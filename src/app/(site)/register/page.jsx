...
export default function Register() {
  ...
  return (
    <main className="w-full h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full space-y-6 text-gray-600 md:max-w-lg">
        <div className="text-center">
          <div className="flex justify-center items-center">
            ...
            <p className="text-2xl font-medium">IntelliBlog</p>
          </div>
        ...
        <div className="space-y-5 bg-white shadow p-4 py-6 sm:p-6 sm:rounded-lg">
          <form onSubmit={(e) => registerUser(e)} className="space-y-7">
            <div className="flex gap-6">
              <div>
                ...
                <input
                  ...
                  maxLength={50}
                  required
                  className="border border-gray-300 w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                />
              </div>
              <div>
                <label className="font-medium">Last Name</label>
                <input
                  value={data.lastName.split()[0].trim()}
                  onChange={(e) =>
            ...
            <div>
              ...
              />
              <span
                className={`${!data.email || emailRegex.test(data.email) ? "hidden" : null
              ...
              <div className="mt-8">
                ...
                <div className="relative mt-2">
                  <button
                    className={`${data.password && data.password.length < 8 ? "mb-6" : null
                      } text-gray-400 absolute right-2 inset-y-0 my-auto active:text-gray-600`}
                    onClick={(e) => {
                      e.preventDefault();
                  ...
                  />
                  <span
                    className={`${!data.password.length || data.password.length >= 8
                        ? "hidden"
                        : null
              ...
              <div className="mt-8">
                ...
                <div className="relative mt-2">
                  <button
                    className={`${data.confirmPassword &&
